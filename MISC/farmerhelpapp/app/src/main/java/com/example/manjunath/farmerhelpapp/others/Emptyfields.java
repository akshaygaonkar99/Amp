...
public class Emptyfields extends AppCompatActivity implements ImageAdapter.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new ImageAdapter(Emptyfields.this,muploads);
        mAdapter.setOnItemClickListener(Emptyfields.this);
        mrecyclerview.setAdapter(mAdapter);
        mprogressbar = findViewById(R.id.progress_circle);
        mDatabaseRef = FirebaseDatabase.getInstance().getReference("uploads/Empty Fields");
        ...
        mdblistener = mDatabaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(Emptyfields.this,databaseError.getMessage(),Toast.LENGTH_SHORT).show();
                mprogressbar.setVisibility(View.INVISIBLE);
            }
        });
    }
    ...
    public void ondeleteClick(int position) {
        ...
        imageref.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                ...
                Toast.makeText(Emptyfields.this,"Item Deleted",Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void onbooking(int position) {
        Intent intent1 = new Intent(Emptyfields.this,booking.class);
        Upload clickeditem = muploads.get(position);
