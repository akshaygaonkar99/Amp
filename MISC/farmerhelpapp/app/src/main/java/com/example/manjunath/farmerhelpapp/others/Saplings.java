...
public class Saplings extends AppCompatActivity implements ImageAdapter.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new ImageAdapter(Saplings.this,muploads);
        mAdapter.setOnItemClickListener(Saplings.this);
        mrecyclerview.setAdapter(mAdapter);
        mprogressbar = findViewById(R.id.progress_circle);
        mDatabaseRef = FirebaseDatabase.getInstance().getReference("uploads/Saplings");
        ...
        mdblistener = mDatabaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(Saplings.this,databaseError.getMessage(),Toast.LENGTH_SHORT).show();
                mprogressbar.setVisibility(View.INVISIBLE);
            }
        });
    }
    ...
    public void ondeleteClick(int position) {
        ...
        imageref.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                ...
                Toast.makeText(Saplings.this,"Item Deleted",Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void onbooking(int position) {
        Intent intent1 = new Intent(Saplings.this,booking.class);
        Upload clickeditem = muploads.get(position);
