...
import com.example.manjunath.farmerhelpapp.activity.MainActivity;
import com.example.manjunath.farmerhelpapp.activity.Moreinfo;
import com.example.manjunath.farmerhelpapp.activity.add_item;
...
public class Machinery extends AppCompatActivity implements ImageAdapter.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new ImageAdapter(Machinery.this,muploads);
        mAdapter.setOnItemClickListener(Machinery.this);
        ...
        mdblistener = mDatabaseRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(Machinery.this,databaseError.getMessage(),Toast.LENGTH_SHORT).show();
                mprogressbar.setVisibility(View.INVISIBLE);
            }
        });
    }
    ...
    public void ondeleteClick(int position) {
        ...
        imageref.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                     ...
                     Toast.makeText(Machinery.this,"Item Deleted",Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void onbooking(int position) {
        Intent intent1 = new Intent(Machinery.this,booking.class);
        Upload clickeditem = muploads.get(position);
